...
namespace AzureStoreRP.Data.Contracts
{
    ...
    [CollectionDataContract(Name = "OutputItems", Namespace = "http://schemas.microsoft.com/windowsazure")]
    public class OutputItemList : List<OutputItem>
    {
        ...
        public OutputItemList(OutputItem output)
            : base(new OutputItem[] { output })
        {
        }
